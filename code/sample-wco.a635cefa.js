import{s as d,r as s,$ as c,n as p}from"./index.c8de6839.js";var u=Object.defineProperty,b=Object.getOwnPropertyDescriptor,g=(a,t,o,i)=>{for(var e=i>1?void 0:i?b(t,o):t,r=a.length-1,n;r>=0;r--)(n=a[r])&&(e=(i?n(t,o,e):n(e))||e);return i&&e&&u(t,o,e),e};let l=class extends d{_randomNotification(){const a="\u4E2D\u56FD PWA \u5F00\u53D1\u8005\u65E5",i={body:"\u4E3A\u52A0\u901F\u63A8\u52A8\u6E10\u8FDB\u5F0F Web \u5E94\u7528 (PWA) \u5728\u4E2D\u56FD\u7684\u53D1\u5C55\uFF0C\u5FAE\u8F6F\u4E0E\u82F1\u7279\u5C14\u643A\u624B\u4E3E\u529E\u201C\u7B2C\u4E8C\u5C4A\u4E2D\u56FD PWA \u5F00\u53D1\u8005\u65E5\u201D\u3002",icon:"assets/icons/icon_96.png"};new Notification(a,i)}_n(){Notification.requestPermission().then(a=>{a==="granted"&&this._randomNotification()})}async connectedCallback(){super.connectedCallback()}static get styles(){return s`
    .about {
      padding: 0 16px;
    ...
    `}constructor(){super()}render(){return c`
      <div id="titleBarContainer">
        <div id="titleBar" class=" draggable">
          ...
          <div class="nonDraggable">北京 ☀️ 上海 🌧️ 漠河 ❄️ 三沙 🌩️ 乌恰 🌞 抚远 🌞</div>
        </div>
      </div>
      ...
      <div class="about">
        ...
        <h2>窗口控件覆盖 (Window Controls Overlay)</h2>
        <fluent-card class="act">
           Window Controls Overlay API 使安装在系统中的渐进式 Web 应用能够隐藏默认窗口标题栏，并在应用窗口的表面区域显示自己的内容，将控制按钮（最大化、最小化和关闭）转换成一个覆盖。
           <ul>
    ...
    `}};l=g([p("sample-wco")],l);export{l as SampleWCO};
//# sourceMappingURL=sample-wco.a635cefa.js.map
