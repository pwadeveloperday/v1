import{s as d,r as p,$ as u,i as b,n as g}from"./index.6954b438.js";var h=Object.defineProperty,m=Object.getOwnPropertyDescriptor,l=(i,o,e,t)=>{for(var a=t>1?void 0:t?m(o,e):o,r=i.length-1,n;r>=0;r--)(n=i[r])&&(a=(t?n(o,e,a):n(a))||a);return t&&a&&h(o,e,a),a};let s=class extends d{constructor(){super()}_randomNotification(){const i="\u4E2D\u56FD PWA \u5F00\u53D1\u8005\u65E5",t={body:"\u4E3A\u52A0\u901F\u63A8\u52A8\u6E10\u8FDB\u5F0F Web \u5E94\u7528 (PWA) \u5728\u4E2D\u56FD\u7684\u53D1\u5C55\uFF0C\u5FAE\u8F6F\u4E0E\u82F1\u7279\u5C14\u643A\u624B\u4E3E\u529E\u201C\u7B2C\u4E8C\u5C4A\u4E2D\u56FD PWA \u5F00\u53D1\u8005\u65E5\u201D\u3002",icon:"assets/icons/icon_96.png"};new Notification(i,t)}_n(){Notification.requestPermission().then(i=>{i==="granted"&&this._randomNotification()})}async _showWeather(){let e=(await(await fetch("https://restapi.amap.com/v3/weather/weatherInfo?city=110105&key=39a5a5f5239a28b739e6a79381afb97e")).json()).lives,t=e[0].city;t=t.replace("\u533A","");const a=`${e[0].province}${t} ${e[0].weather} ${e[0].temperature}\u2103`;e=(await(await fetch("https://restapi.amap.com/v3/weather/weatherInfo?city=310112&key=39a5a5f5239a28b739e6a79381afb97e")).json()).lives,t=e[0].city,t=t.replace("\u533A","");const c=`${e[0].province}${t} ${e[0].weather} ${e[0].temperature}\u2103`;this._weather.innerHTML=`${a} ${c}`}async connectedCallback(){super.connectedCallback()}static get styles(){return p`
    .about {
      padding: 0 16px;
    ...
    `}};l([b("#weather")],s.prototype,"_weather",2);s=l([g("sample-wco")],s);export{s as SampleWCO};
//# sourceMappingURL=sample-wco.874fd6fe.js.map
