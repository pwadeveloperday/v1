import{s as d,r as p,$ as h,i as s,n as m}from"./index.2973c676.js";var u=Object.defineProperty,g=Object.getOwnPropertyDescriptor,i=(e,r,c,n)=>{for(var a=n>1?void 0:n?g(r,c):r,o=e.length-1,l;o>=0;o--)(l=e[o])&&(a=(n?l(r,c,a):l(a))||a);return n&&a&&u(r,c,a),a};let t=class extends d{constructor(){super()}async _showUrlParameters(){const e=location.search;if(console.log(e),e.trim()){this._msg.innerHTML=`
        search: ${e}, \u6210\u529F\u8C03\u7528
      `;let r=e.split("://")[1],o=(await(await fetch(`https://restapi.amap.com/v3/geocode/geo?address=${r}&output=JSON&key=39a5a5f5239a28b739e6a79381afb97e`)).json()).geocodes[0].location;this._geolocation.innerHTML=o;const l=await fetch(`https://restapi.amap.com/v3/staticmap?location=${o}&zoom=10&size=375*250&markers=mid,,A:${o}&key=39a5a5f5239a28b739e6a79381afb97e`);this._map.innerHTML=`<img src="${l}">`}else this._msg.innerHTML="\u65E0 web+pwadev://* \u8C03\u7528"}_updateUph(){let e=`web+pwadev://${this._iuph.value}`;this._uph.innerHTML=e,this._uph.href=e}async connectedCallback(){super.connectedCallback(),setTimeout(()=>{this._showUrlParameters()},3e3)}static get styles(){return p`
    .about {
      padding: 0 16px;
...
//# sourceMappingURL=sample-uph.34dca1ca.js.map
