import{s as c,r as p,$ as d,i as u,n as h}from"./index.78b2020d.js";import"./lit-video.6fc33520.js";var v=Object.defineProperty,g=Object.getOwnPropertyDescriptor,a=(t,e,o,l)=>{for(var i=l>1?void 0:l?g(e,o):e,n=t.length-1,s;n>=0;n--)(s=t[n])&&(i=(l?s(e,o,i):s(i))||i);return l&&i&&v(e,o,i),i};let r=class extends c{constructor(){super()}async _playLocalVideo(){let t;[t]=await showOpenFilePicker();const e=await t.getFile();this.video.src=URL.createObjectURL(e)}async _playFileHandlerVideo(){"launchQueue"in window&&"files"in LaunchParams.prototype&&(console.log("\u60A8\u7684\u6D4F\u89C8\u5668\u652F\u6301\u6587\u4EF6\u5904\u7406 API"),launchQueue.setConsumer(async t=>{if(!t.files.length){this.msg.innerHTML="\u6CA1\u6709\u4ECE\u89C6\u9891\u6587\u4EF6\u90AE\u4EF6\u83DC\u5355\u6253\u5F00\u672C\u9875\u9762";return}for(let e of t.files){console.log(e);const o=await e.getFile();console.log(o),this.video.src=URL.createObjectURL(o)}}))}async connectedCallback(){super.connectedCallback(),this._playFileHandlerVideo()}static get styles(){return p`
    ...
    `}};a([u("#first-video")],r.prototype,"video",2);a([u("#msg")],r.prototype,"msg",2);r=a([h("sample-mp")],r);export{r as SampleMP};
//# sourceMappingURL=sample-mp.08a18822.js.map
