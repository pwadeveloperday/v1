import{s,r as d,$ as l,n as u}from"./index.aa948201.js";var p=Object.defineProperty,b=Object.getOwnPropertyDescriptor,g=(i,t,r,o)=>{for(var e=o>1?void 0:o?b(t,r):t,a=i.length-1,n;a>=0;a--)(n=i[a])&&(e=(o?n(t,r,e):n(e))||e);return o&&e&&p(t,r,e),e};let c=class extends s{_randomNotification(){const i="\u4E2D\u56FD PWA \u5F00\u53D1\u8005\u65E5",o={body:"\u4E3A\u52A0\u901F\u63A8\u52A8\u6E10\u8FDB\u5F0F Web \u5E94\u7528 (PWA) \u5728\u4E2D\u56FD\u7684\u53D1\u5C55\uFF0C\u5FAE\u8F6F\u4E0E\u82F1\u7279\u5C14\u643A\u624B\u4E3E\u529E\u201C\u7B2C\u4E8C\u5C4A\u4E2D\u56FD PWA \u5F00\u53D1\u8005\u65E5\u201D\u3002",icon:"assets/icons/icon_96.png"},e=new Notification(i,o);setTimeout(this._randomNotification,3e3),e.onshow=function(){var a=this;setTimeout(function(){a.close()},3e3)}}_n(){Notification.requestPermission().then(i=>{i==="granted"&&this._randomNotification()})}async connectedCallback(){super.connectedCallback()}static get styles(){return d`
    .about {
      padding: 0 16px;
...
//# sourceMappingURL=sample-n.9cea1b80.js.map
