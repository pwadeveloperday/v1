import{s as d,r as p,$ as h,i as s,n as m}from"./index.73b11a3b.js";var u=Object.defineProperty,g=Object.getOwnPropertyDescriptor,r=(e,i,c,n)=>{for(var a=n>1?void 0:n?g(i,c):i,o=e.length-1,l;o>=0;o--)(l=e[o])&&(a=(n?l(i,c,a):l(a))||a);return n&&a&&u(i,c,a),a};let t=class extends d{constructor(){super()}async _showUrlParameters(){const e=location.search;if(console.log(e),e.trim()){this._msg.innerHTML=`
        search: ${e}, \u6210\u529F\u8C03\u7528
      `;let i=e.split("://")[1],o=(await(await fetch(`https://restapi.amap.com/v3/geocode/geo?address=${i}&output=JSON&key=39a5a5f5239a28b739e6a79381afb97e`)).json()).geocodes[0].location;this._geolocation.innerHTML=o;const l=await fetch(`https://restapi.amap.com/v3/staticmap?location=${o}&zoom=10&size=375*250&markers=mid,,A:${o}&key=39a5a5f5239a28b739e6a79381afb97e`);this._map.innerHTML=`<img src="${l}">`}else this._msg.innerHTML="\u65E0 web+pwadev://* \u8C03\u7528"}_updateUph(){let e=`web+pwadev://${this._iuph.value}`;this._uph.innerHTML=e,this._uph.href=e}async connectedCallback(){super.connectedCallback(),setTimeout(()=>{this._showUrlParameters()},3e3)}static get styles(){return p`
    .about {
      padding: 0 16px;
    ...
    `}};r([s("#msg")],t.prototype,"_msg",2);r([s("#uph")],t.prototype,"_uph",2);r([s("#iuph")],t.prototype,"_iuph",2);r([s("#geolocation")],t.prototype,"_geolocation",2);r([s("#map")],t.prototype,"_map",2);t=r([m("sample-uph")],t);export{t as SampleUPH};
//# sourceMappingURL=sample-uph.909a4df0.js.map
