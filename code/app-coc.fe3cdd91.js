import{s as c,r as s,$ as h,n as l}from"./index.7ba2b8c9.js";var i=Object.defineProperty,m=Object.getOwnPropertyDescriptor,u=(d,e,a,p)=>{for(var r=p>1?void 0:p?m(e,a):e,t=d.length-1,o;t>=0;t--)(o=d[t])&&(r=(p?o(e,a,r):o(r))||r);return p&&r&&i(e,a,r),r};let n=class extends c{static get styles(){return s`
    .about {
      padding: 0 16px;
    ...
    `}constructor(){super()}render(){return h`
      ...
      <div class="about">
        ...
        <fluent-card>
          ...
          <fluent-card>
          <h3>报告行为准则问题</h3>
          <p>如果您需要任何形式的帮助、报告不良情况或任何其他未指定我们可以提供帮助的事情，您可以通过以下方式联系我们：
          </p>
          <p>私信 @PWADevDay</p>
...
//# sourceMappingURL=app-coc.fe3cdd91.js.map
