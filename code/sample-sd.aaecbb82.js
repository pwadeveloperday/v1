import{s as l,r as p,$ as u,i as d,e as m,n as g}from"./index.2973c676.js";var b=Object.defineProperty,h=Object.getOwnPropertyDescriptor,n=(c,t,a,r)=>{for(var e=r>1?void 0:r?h(t,a):t,o=c.length-1,s;o>=0;o--)(s=c[o])&&(e=(r?s(t,a,e):s(e))||e);return r&&e&&b(t,a,e),e};let i=class extends l{constructor(){super()}async _bc(){if(!("BarcodeDetector"in window)||!(await BarcodeDetector.getSupportedFormats()).includes("qr_code")){this._msg.innerHTML="\u6D4F\u89C8\u5668\u5728\u8BE5\u7CFB\u7EDF\u4E0D\u652F\u6301\u4E8C\u7EF4\u7801\u68C0\u6D4B";return}else{const c=await navigator.mediaDevices.getUserMedia({video:{facingMode:{ideal:"environment"}},audio:!1});if(this._stream.srcObject=c,await this._stream.play(),this._stream)try{let t=this._stream,a=new BarcodeDetector.getSupportedFormats,e=await new BarcodeDetector({formats:a}).detect(t);this._msg.innerHTML=e.map(o=>o.rawValue)}catch(t){this._msg.innerHTML=t}}}async _pausec(){this._stream.pause()}async connectedCallback(){super.connectedCallback()}static get styles(){return p`
    .about {
      padding: 0 16px;
    ...
    `}};n([d("#stream")],i.prototype,"_stream",2);n([d("#msg")],i.prototype,"_msg",2);n([m({type:Function})],i.prototype,"interval",2);i=n([g("sample-sd")],i);export{i as SampleSD};
//# sourceMappingURL=sample-sd.aaecbb82.js.map
