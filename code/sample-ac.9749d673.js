import{s as l,r as p,$ as b,i as d,n as g}from"./index.73b11a3b.js";var u=Object.defineProperty,m=Object.getOwnPropertyDescriptor,s=(e,a,r,o)=>{for(var t=o>1?void 0:o?m(a,r):a,c=e.length-1,n;c>=0;c--)(n=e[c])&&(t=(o?n(a,r,t):n(t))||t);return o&&t&&u(a,r,t),t};let i=class extends l{constructor(){super()}async _loadBlob(e){return await(await fetch(e)).blob()}async _copy(){try{const e="https://pwadev.io/assets/sample/pwa-fugu.png",a=await this._loadBlob(e),r=new ClipboardItem({"image/png":a});await navigator.clipboard.write([r]),this._msg.innerHTML="\u56FE\u7247\u5DF2\u590D\u5236"}catch(e){this._msg.innerHTML=e.message}}async _paste(){try{const e=await navigator.clipboard.read();console.log(e);const a=await e[0].getType("image/png");this._p.innerHTML=`
        <img src='${window.URL.createObjectURL(a)}'>
      `,this._msg.innerHTML="\u56FE\u7247\u5F02\u6B65\u7C98\u8D34\u6210\u529F"}catch(e){this._msg.innerHTML=e.message+" Failed to read clipboard"}}async connectedCallback(){super.connectedCallback()}static get styles(){return p`
    .about {
      padding: 0 16px;
    ...
    `}};s([d("#msg")],i.prototype,"_msg",2);s([d("#paste")],i.prototype,"_p",2);i=s([g("sample-ac")],i);export{i as SampleAC};
//# sourceMappingURL=sample-ac.9749d673.js.map
