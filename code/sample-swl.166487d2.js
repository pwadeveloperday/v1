import{s as d,r as u,$ as p,i as l,e as g,n as b}from"./index.d9644d58.js";var m=Object.defineProperty,h=Object.getOwnPropertyDescriptor,i=(e,t,n,o)=>{for(var a=o>1?void 0:o?h(t,n):t,s=e.length-1,c;s>=0;s--)(c=e[s])&&(a=(o?c(t,n,a):c(a))||a);return o&&a&&m(t,n,a),a};let r=class extends d{constructor(){super(),this._log=""}_logMsg(e){this._msg.innerHTML+=`${new Date().toUTCString()} ${e}<br>`}async _visibility(){if("wakeLock"in navigator){let e;if(e){this._logMsg('Release "Screen" button pressed.'),e.release();return}try{this._logMsg("\u5DF2\u70B9\u51FB\u83B7\u53D6\u5C4F\u5E55\u5524\u9192\u9501\u6309\u94AE"),e=await navigator.wakeLock.request("screen"),this.screen_status.textContent="\u5DF2\u83B7\u53D6",this._logMsg("\u5C4F\u5E55\u5524\u9192\u9501\u5DF2\u83B7\u53D6"),e.addEventListener("release",()=>{this.screen_status.textContent="\u5DF2\u91CA\u653E",this._logMsg("\u5C4F\u5E55\u5524\u9192\u9501\u5DF2\u83B7\u53D6"),e=null})}catch(t){this.screen_status.textContent=`${t.name}: ${t.message}`,this._logMsg(`Caught ${t.name} acquiring "Screen" lock: ${t.message}`)}}document.addEventListener("visibilitychange",()=>{this._logMsg(`\u6587\u6863\u53EF\u89C1\u6027\uFF08document visibility\uFF09\u53D8\u4E3A "${document.visibilityState}"`)})}async connectedCallback(){super.connectedCallback()}static get styles(){return u`
    ...
    `}};i([l("#msg")],r.prototype,"_msg",2);i([l("#screen")],r.prototype,"screen",2);i([l("#screen_status")],r.prototype,"screen_status",2);i([g({type:String})],r.prototype,"_log",2);r=i([b("sample-swl")],r);export{r as SampleSWL};
//# sourceMappingURL=sample-swl.166487d2.js.map
