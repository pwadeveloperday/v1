import{s as C,r as c,$ as n,o as l,e as d,n as h}from"./index.d6c957b0.js";var v=Object.defineProperty,g=Object.getOwnPropertyDescriptor,r=(t,e,i,a)=>{for(var u=a>1?void 0:a?g(e,i):e,o=t.length-1,p;o>=0;o--)(p=t[o])&&(u=(a?p(e,i,u):p(u))||u);return a&&u&&v(e,i,u),u};let s=class extends C{constructor(){super(),this.description=`
  ...
  `,this.jsondata={name:"PWA Developer Day 2022",devday:[{id:1,time:"13:00",tag:"",title:"\u5F00\u5E55\u81F4\u8F9E",des:"",speaker:"\u5F20\u7426",pos:"\u8D44\u6DF1\u6280\u672F\u603B\u76D1",com:"\u82F1\u7279\u5C14 SATG Web \u5E73\u53F0\u5DE5\u7A0B",iconid:"qi",icon:"assets/2022/people/120/qi.png",icon5:"assets/2022/people/500/qi.png",bio:""}],t2022:{},t2021:[{id:1,tag:"opening",title:"Web \u5F00\u53D1\u7684\u73B0\u72B6\u4E0E\u672A\u6765\uFF08\u5F00\u573A\u4ECB\u7ECD\uFF09",des:"",speaker:"\u5F20\u7426",pos:"\u8D44\u6DF1\u6280\u672F\u603B\u76D1",com:"\u8F6F\u4EF6\u4E0E\u5148\u8FDB\u6280\u672F\u4E8B\u4E1A\u90E8 Web \u5E73\u53F0\u5DE5\u7A0B",icon:"",icon5:"assets/2022/people/500/qi.png",bio:"",pdf:"https://d3i5xkfad89fac.cloudfront.net/pwa/2021/slides/02.pdf",bilibili:"https://www.bilibili.com/video/BV1Kv4y1G7L8",aid:"554870624",cid:"741436422",youtube:"https://youtu.be/npMpZHMizUc"}]},this.screenwidth="",this.screenheight=""}screenres(){let e=screen.availWidth-64,i=e*9/16;this.screenwidth=e.toString(),this.screenheight=i.toString()}async connectedCallback(){super.connectedCallback(),this.screenres(),await this.fetchData()}async fetchData(){await fetch("/data.json");const t=await fetch("/data.json");this.jsondata=await t.json()}static get styles(){return c`
    ...
    `}render(){if(this.jsondata){let t="";for(let e of this.jsondata.t2021){let i="";e.pdf&&(i=`
      ...
      `}else return n`<div>No data</div>`}};r([d({type:String})],s.prototype,"description",2);r([d({type:Object})],s.prototype,"jsondata",2);r([d({type:String})],s.prototype,"screenwidth",2);r([d({type:String})],s.prototype,"screenheight",2);s=r([h("app-2021")],s);export{s as App2021};
//# sourceMappingURL=app-2021.c9345388.js.map
