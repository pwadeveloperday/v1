import{s as d,r as p,$ as h,i as s,n as m}from"./index.7257f0e0.js";var u=Object.defineProperty,g=Object.getOwnPropertyDescriptor,i=(e,r,c,n)=>{for(var o=n>1?void 0:n?g(r,c):r,a=e.length-1,l;a>=0;a--)(l=e[a])&&(o=(n?l(r,c,o):l(o))||o);return n&&o&&u(r,c,o),o};let t=class extends d{constructor(){super()}async _showUrlParameters(){const e=location.search;if(console.log(e),e.trim()){this._msg.innerHTML=`
        search: ${e}, \u6210\u529F\u8C03\u7528
      `;let r=e.split("://")[1],a=(await(await fetch(`https://restapi.amap.com/v3/geocode/geo?address=${r}&output=JSON&key=39a5a5f5239a28b739e6a79381afb97e`)).json()).geocodes[0].location;this._geolocation.innerHTML=a;const l=await fetch(`https://restapi.amap.com/v3/staticmap?location=${a}&zoom=10&size=375*250&markers=mid,,A:${a}&key=39a5a5f5239a28b739e6a79381afb97e`);this._map.innerHTML=`<img src="${l}">`}else this._msg.innerHTML="\u65E0 web+coffee://* \u8C03\u7528"}_updateUph(){let e=`web+coffee://${this._iuph.value}`;this._uph.innerHTML=e,this._uph.href=e}async connectedCallback(){super.connectedCallback(),setTimeout(()=>{this._showUrlParameters()},3e3)}static get styles(){return p`
    .about {
      padding: 0 16px;
    ...
    `}};i([s("#msg")],t.prototype,"_msg",2);i([s("#uph")],t.prototype,"_uph",2);i([s("#iuph")],t.prototype,"_iuph",2);i([s("#geolocation")],t.prototype,"_geolocation",2);i([s("#map")],t.prototype,"_map",2);t=i([m("sample-uph")],t);export{t as SampleUPH};
//# sourceMappingURL=sample-uph.616be6a2.js.map
