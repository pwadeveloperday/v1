import{s as l,r as p,$ as u,i as d,e as g,n as m}from"./index.9f51dc56.js";var b=Object.defineProperty,h=Object.getOwnPropertyDescriptor,n=(o,a,r,t)=>{for(var e=t>1?void 0:t?h(a,r):a,c=o.length-1,s;c>=0;c--)(s=o[c])&&(e=(t?s(a,r,e):s(e))||e);return t&&e&&b(a,r,e),e};let i=class extends l{constructor(){super()}async _bc(){if(!("BarcodeDetector"in window)||!(await BarcodeDetector.getSupportedFormats()).includes("qr_code")){this._msg.innerHTML="\u6D4F\u89C8\u5668\u5728\u8BE5\u7CFB\u7EDF\u4E0D\u652F\u6301\u4E8C\u7EF4\u7801\u68C0\u6D4B";return}else{const o=await navigator.mediaDevices.getUserMedia({video:{facingMode:{ideal:"environment"}},audio:!1});this._stream.srcObject=o,await this._stream.play(),new BarcodeDetector({formats:["qr_code"]}),this._stream&&(this._stream,this.interval=setInterval(async(a,r)=>{const t=await a.detect(r);t.length<=0||(this._msg.innerHTML=t.map(e=>e.rawValue))},500))}}async _pausec(){clearInterval(this.interval),this._stream.pause()}async connectedCallback(){super.connectedCallback()}static get styles(){return p`
    .about {
      padding: 0 16px;
...
//# sourceMappingURL=sample-sd.5b4832f0.js.map
