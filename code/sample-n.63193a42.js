import{s,r as d,$ as l,n as u}from"./index.d9644d58.js";var p=Object.defineProperty,g=Object.getOwnPropertyDescriptor,b=(o,t,n,a)=>{for(var e=a>1?void 0:a?g(t,n):t,r=o.length-1,i;r>=0;r--)(i=o[r])&&(e=(a?i(t,n,e):i(e))||e);return a&&e&&p(t,n,e),e};let c=class extends s{_randomIntFromInterval(o,t){return Math.floor(Math.random()*(t-o+1)+o)}_n(){let o=this._randomIntFromInterval(1,999),t=`\u7B2C ${o.toString()} \u5C4A\u4E2D\u56FD PWA \u5F00\u53D1\u8005\u65E5`;const e={body:`\u4E3A\u52A0\u901F\u63A8\u52A8\u6E10\u8FDB\u5F0F Web \u5E94\u7528 (PWA) \u5728\u4E2D\u56FD\u7684\u53D1\u5C55\uFF0C\u5FAE\u8F6F\u4E0E\u82F1\u7279\u5C14\u643A\u624B\u4E3E\u529E\u201C\u7B2C ${o.toString()} \u5C4A\u4E2D\u56FD PWA \u5F00\u53D1\u8005\u65E5\u201D\u3002`,icon:"assets/icons/icon_96.png"};Notification.requestPermission(function(r){console.log("\u7528\u6237\u9009\u62E9 ",r),r!=="granted"?console.log("\u672A\u83B7\u5F97\u901A\u77E5\u6743\u9650!"):navigator.serviceWorker.ready.then(function(i){console.log("\u672A\u83B7\u5F97\u901A\u77E5\u6743\u9650!"),i.showNotification(t,e)})})}async connectedCallback(){super.connectedCallback()}static get styles(){return d`
    .about {
      padding: 0 16px;
    ...
    `}};c=b([u("sample-n")],c);export{c as SampleN};
//# sourceMappingURL=sample-n.63193a42.js.map
