import{s as l,r as p,$ as u,i as d,e as g,n as m}from"./index.24c57d04.js";var b=Object.defineProperty,h=Object.getOwnPropertyDescriptor,n=(o,t,r,a)=>{for(var e=a>1?void 0:a?h(t,r):t,c=o.length-1,s;c>=0;c--)(s=o[c])&&(e=(a?s(t,r,e):s(e))||e);return a&&e&&b(t,r,e),e};let i=class extends l{constructor(){super()}async _bc(){if(!("BarcodeDetector"in window)||!(await BarcodeDetector.getSupportedFormats()).includes("qr_code")){this._msg.innerHTML="\u6D4F\u89C8\u5668\u5728\u8BE5\u7CFB\u7EDF\u4E0D\u652F\u6301\u4E8C\u7EF4\u7801\u68C0\u6D4B";return}else{const o=await navigator.mediaDevices.getUserMedia({video:{facingMode:{ideal:"environment"}},audio:!1});this._stream.srcObject=o,await this._stream.play(),new BarcodeDetector({formats:["aztec","code_128","code_39","code_93","codabar","data_matrix","ean_13","ean_8","itf","pdf417","qr_code","upc_a","upc_e"]}),this._stream&&(this._stream,this.interval=setInterval(async(t,r)=>{const a=await t.detect(r);a.length<=0||(this._msg.innerHTML=a.map(e=>e.rawValue))},500))}}async _pausec(){clearInterval(this.interval),this._stream.pause()}async connectedCallback(){super.connectedCallback()}static get styles(){return p`
    .about {
      padding: 0 16px;
    ...
    `}};n([d("#stream")],i.prototype,"_stream",2);n([d("#msg")],i.prototype,"_msg",2);n([g({type:Function})],i.prototype,"interval",2);i=n([m("sample-sd")],i);export{i as SampleSD};
//# sourceMappingURL=sample-sd.32f0d539.js.map
