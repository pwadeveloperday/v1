import{s,r as d,$ as l,n as u}from"./index.79d26c25.js";var p=Object.defineProperty,b=Object.getOwnPropertyDescriptor,g=(i,o,a,t)=>{for(var e=t>1?void 0:t?b(o,a):o,r=i.length-1,n;r>=0;r--)(n=i[r])&&(e=(t?n(o,a,e):n(e))||e);return t&&e&&p(o,a,e),e};let c=class extends s{_randomNotification(){const i="\u4E2D\u56FD PWA \u5F00\u53D1\u8005\u65E5",t={body:"\u4E3A\u52A0\u901F\u63A8\u52A8\u6E10\u8FDB\u5F0F Web \u5E94\u7528 (PWA) \u5728\u4E2D\u56FD\u7684\u53D1\u5C55\uFF0C\u5FAE\u8F6F\u4E0E\u82F1\u7279\u5C14\u643A\u624B\u4E3E\u529E\u201C\u7B2C\u4E8C\u5C4A\u4E2D\u56FD PWA \u5F00\u53D1\u8005\u65E5\u201D\u3002",icon:"assets/icons/icon_96.png"};self.registration.showNotification(i,t)}_n(){Notification.requestPermission().then(i=>{i==="granted"&&this._randomNotification()})}async connectedCallback(){super.connectedCallback()}static get styles(){return d`
    .about {
      padding: 0 16px;
...
//# sourceMappingURL=sample-n.0ddbafc2.js.map
