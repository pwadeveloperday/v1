...
async function generateInjectManifest(options2, viteOptions) {
  ...
  const { rollup } = await Promise.resolve().then(() => __toESM(require("rollup")));
...
function resolveSwPaths(injectManifest, root, srcDir, outDir, filename) {
  ...
  if (injectManifest && (0, import_path4.extname)(filename) === ".ts" && import_fs3.default.existsSync(swSrc)) {
